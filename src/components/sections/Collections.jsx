...
const collectionsData = [
  ...
  },
  {
    ...
    desc: "A cosmic-inspired timepiece with a gradient aventurine dial that mimics the night sky.",
    specs: { size: "41mm", material: "Stainless Steel", movement: "Automatic" },
    img: watchNebula,
  },
  {
    id: "06",
    ...
    desc: "A rugged powerhouse designed for durability, featuring shock resistance and bold architecture.",
    specs: {
      size: "45mm",
  ...
  },
  {
    ...
    desc: "A mesmerizing dial with shifting hues inspired by the northern lights.",
    specs: { size: "39mm", material: "Ceramic", movement: "Automatic" },
    img: watchAurora,
  },
  {
    id: "08",
    ...
    desc: "An opulent statement piece with intricate engravings and a regal aesthetic.",
    specs: { size: "42mm", material: "Yellow Gold", movement: "Automatic" },
    img: watchMonarch,
  },
  {
    id: "09",
    name: "Phantom",
    tagline: "Invisible Precision",
    desc: "A stealth-inspired all-black design with a minimalist dial and high-contrast markers.",
    specs: { size: "43mm", material: "Black PVD Steel", movement: "Automatic" },
    img: watchPhantom,
  },
  {
    id: "10",
    ...
    desc: "A harmonious blend of sport and elegance, featuring dual-time functionality.",
    specs: {
      size: "41mm",
            ...
            <div className="relative z-10 w-full h-full max-w-7xl px-6 py-20 md:py-0 md:px-12 flex flex-col md:flex-row items-center justify-center md:justify-between gap-8 md:gap-12">
              ...
              <div className="flex-1 flex flex-col items-center text-center md:items-start md:text-left w-full watch-text z-20 order-1 md:order-none mt-10 md:mt-0">
                <div className="flex items-center justify-center md:justify-start gap-4 mb-2 md:mb-4">
                  <span className="text-[#D4AF37] font-display text-lg md:text-xl">
                    {collection.id}.
                  </span>
                  <span className="h-[1px] w-8 md:w-12 bg-[#D4AF37]/50"></span>
                  <span className="uppercase tracking-[0.2em] text-zinc-500 text-xs md:text-sm">
                    {collection.tagline}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4 w-full max-w-sm md:max-w-md mb-8 md:mb-10">
                  <div className="bg-white/5 border border-white/10 p-3 md:p-4 rounded-xl backdrop-blur-md">
                    ...
                    <div className="text-[10px] md:text-xs text-zinc-500 uppercase tracking-wider mb-1">
                      Case
                    </div>
                    <div className="text-white text-xs md:text-sm font-medium">
                      {collection.specs.size} {collection.specs.material}
                    </div>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 md:p-4 rounded-xl backdrop-blur-md">
                    ...
                    <div className="text-white text-xs md:text-sm font-medium">
                      {collection.specs.movement}
                    </div>
                  </div>
                </div>

                <button className="flex items-center gap-3 text-white hover:text-[#D4AF37] transition-colors group">
                  <span className="uppercase tracking-[0.15em] text-xs md:text-sm font-medium">
                    Discover Piece
                  </span>
